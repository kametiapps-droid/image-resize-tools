...
const topics = [
  { icon: Bug, title: "Report a Bug", desc: "Found something that doesn't work correctly? Include your browser name, operating system, and what happened.", email: EMAIL },
  { icon: Lightbulb, title: "Feature Request", desc: "Have an idea for a new tool or an improvement to an existing one? We'd love to hear your suggestions.", email: EMAIL },
  { icon: MessageCircle, title: "General Inquiry", desc: "Any other questions, feedback, business inquiries, or partnerships.", email: EMAIL },
  { icon: Mail, title: "Privacy or Legal", desc: "Privacy concerns, DMCA requests, data deletion requests, or any legal matters.", email: EMAIL },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-gray-500 dark:text-gray-400 max-w-lg mx-auto text-base leading-relaxed">
            We're the <strong className="text-gray-700 dark:text-gray-200">{AUTHOR}</strong> — the team behind {SITE}. We read every message and typically respond within 1–2 business days.
          </p>
        </div>
          ...
          {topics.map((t) => {
            ...
            return (
              <div key={t.title} className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-green-300 dark:hover:border-green-700 transition-all">
                ...
                <a href={`mailto:${t.email}`} className="text-sm font-medium text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-colors hover:underline">
                  {t.email}
                </a>
              </div>
            );
