...
const topics = [
  { icon: Bug, title: "Report a Bug", desc: "Found something that doesn't work correctly? Let us know so we can fix it quickly.", email: "bugs@imagetoolz.app" },
  { icon: Lightbulb, title: "Feature Request", desc: "Have an idea for a new tool or improvement? We'd love to hear your suggestions.", email: "ideas@imagetoolz.app" },
  { icon: MessageCircle, title: "General Inquiry", desc: "Any other questions, feedback, or partnership inquiries.", email: "hello@imagetoolz.app" },
  { icon: Mail, title: "Privacy or Legal", desc: "Privacy concerns, DMCA requests, or legal inquiries.", email: "legal@imagetoolz.app" },
];
          ...
          {topics.map((t) => {
            ...
            return (
              <div key={t.title} className="p-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-green-300 dark:hover:border-green-700 transition-all">
                ...
                <a href={`mailto:${t.email}`} className="text-sm font-medium text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 transition-colors">
                  {t.email}
                </a>
              </div>
            );
