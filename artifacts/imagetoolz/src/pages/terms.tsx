      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14">
        <div className="mb-10">
          ...
          <p className="mt-4 text-gray-600 text-base leading-relaxed">
            Please read these Terms of Service carefully before using ImageToolz. By accessing or using our service, you agree to be bound by these terms.
          </p>
        </div>
        ...
        <div className="space-y-10 text-gray-700">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              By using ImageToolz ("the Service"), you agree to these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use the Service. These terms apply to all users of the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ImageToolz provides free, browser-based image processing tools including image resizing, compression, format conversion, cropping, watermarking, rotation, color picking, PDF conversion, and metadata removal. All processing occurs locally in your browser — no images are uploaded to our servers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              You retain all ownership rights to the images you process using ImageToolz. We do not claim any ownership or rights to your content. The ImageToolz website, its design, code, and branding are owned by ImageToolz and may not be reproduced without permission.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              To the maximum extent permitted by law, ImageToolz shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of data, revenue, or profits arising from your use of the Service, even if we have been advised of the possibility of such damages.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">7. Third-Party Advertising</h2>
            <p className="leading-relaxed">
              ImageToolz displays advertisements provided by Google AdSense and potentially other third-party ad networks to fund the free service. We are not responsible for the content of these advertisements. By using our Service, you consent to the display of such advertisements.
            </p>
          </section>
